    ...
    <div className='home'>
      ...
      <div className="hero">
        ...
        <div className="hero-caption">
          <img src={hero_title} />
          <p>Discovering his ties to a secret ancient order, a young man living in modern Istanbul embarks on a quest to save the city from an immortal enemy. lorem</p>
